        ...
        <div className="px-8 flex justify-between">
          <div className="max-w-[600px] flex flex-col gap-12">
            <div className="flex flex-col gap-2">
              <p className="tom text-6xl font-bold leading-[72px] tracking-[-1.2px] text-[var(--secondary-text-color)] font-text">
                Hi, I'm Tom 👋
              </p>
              <p className="content">
            ...
            <div className="flex">
              <a
                ...
                className="p-1.5 flex rounded-lg hover:bg-[var(--zuraas)] active:bg-[var(--image-box)]"
              >
                <GitHubIcon />
              </a>
              <a
